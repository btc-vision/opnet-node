...
export const RoswellConsensus: IOPNetConsensus<Consensus.Roswell> = {
        ...
        EARLY_MINING: {
            [ChainIds.Bitcoin]: {
                [BitcoinNetwork.mainnet]: {
                    ...
                    PATCH_2_ENABLE_AT_BLOCK: 948230n,
                    EXPIRES_AT_BLOCK_PATCH_2: 1000069n,
                },
                [BitcoinNetwork.testnet]: {
                    ENABLED: false,
                },
    ...
    CONTRACTS: {
        ...
        MAXIMUM_CONTRACT_SIZE_COMPRESSED: 1536 * 1024, // max is 1.5MB compressed.
